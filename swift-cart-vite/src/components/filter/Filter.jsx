        ...
        <div>
            <div className=' container mx-auto px-4 mt-5 '>
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                    style={{
                        backgroundColor: mode === 'dark' ? '#4C99B1' : '#95D5E9',
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button className="px-4 py-2 border-blue-300 solid border-2 hover:bg-blue-200 text-gray-800 text-sm font-medium rounded-md" style={{ color: mode === 'dark' ? 'white' : '' }}>
                            Reset Filter
                        </button>
                    </div>
                    <div>
