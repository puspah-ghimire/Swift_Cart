        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  bg-swiftCart py-2 text-center rounded-lg text-white font-bold hover:bg-swiftCartDark"
                >
                    Buy Now
                </button>
            </div>
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <form className="space-y-4 md:space-y-6" action="#">
                                                        ...
                                                        <div>
                                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Enter Address</label>
                                                    ...
                                                    <button onClick={ closeModal} type="button" className="focus:outline-none w-full text-white bg-swiftCart hover:bg-swiftCartDark  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
